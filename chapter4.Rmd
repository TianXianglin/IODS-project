...
## RStudio exercise 4: Data analysis
...
You can find my [preprocessed data set]() and the [data wrangling R script]() from my [GitHub repository.](https://github.com/anorring/IODS-project/tree/master/data)
